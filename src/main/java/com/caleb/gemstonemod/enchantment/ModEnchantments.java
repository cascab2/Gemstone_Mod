...
public class ModEnchantments {
    ...
    public static final ResourceKey<Enchantment> ARCHAEOLOGY = ResourceKey.create(Registries.ENCHANTMENT,
            ResourceLocation.fromNamespaceAndPath(GemstoneMod.MOD_ID, "archaeology"));
    ...
    public static void bootstrap(BootstrapContext<Enchantment> context) {
        ...
        register(context, ARCHAEOLOGY, Enchantment.enchantment(Enchantment.definition(
                        ...
                        2,
                        EquipmentSlotGroup.MAINHAND))
                .withEffect(EnchantmentEffectComponents.TICK, new ArchaeologyEnchantmentEffect()));
    }
